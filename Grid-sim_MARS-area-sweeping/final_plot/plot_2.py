...
Custom_lagend = {
    ...
    "WH_ANT_RECALL_FILTER_SWEEP": "WH-Baseline+"
}
        ...
        for comm_range in range_list:
            ...
            if os.path.exists(folder_path):
                ...
                for file_name, content in all_yaml_files.items():
                    ...
                    move_counts = [agent['move_count'] for agent in agents_statistic.values()]

                    task_completeness_list.append(swept_cells_num / task_cells_num * 100)
                    move_count_SD_list.append(np.std(move_counts))
...
# =================================================
# TASK COMPLETENESS — LINE PLOTS (UPPER / LOWER)
# =================================================
...
# =================================================
# STD OF OPERATING TIME — LINE PLOTS (UPPER / LOWER)
# =================================================
fig, axs = plt.subplots(2, 1, figsize=(12, 10), sharex=True)
