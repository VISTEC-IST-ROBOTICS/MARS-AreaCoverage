...
def main():
    ...
    #range_list = ['range_2', 'range_3']
    #alg_list = ["GSR_SWEEP", "GSR_SWEEP_RECALL", "ANT_SWEEP", "ANT_RECALL_FILTER_SWEEP"]
    alg_list = ["ANT_RECALL_FILTER_SWEEP","WH_ANT_RECALL_FILTER_SWEEP"]
    alg_list = ["GSR_SWEEP", "GSR_SWEEP_RECALL", "ANT_SWEEP","ANT_RECALL_FILTER_SWEEP","WH_ANT_RECALL_FILTER_SWEEP"]
    for alg in alg_list:
        for exp_range in range_list:

            config_path = f'experiment-3/{alg}/{exp_range}/config.yaml'
